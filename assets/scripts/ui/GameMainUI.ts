...
export class GameMainUI {
    ...
    show(): void {
        ...
        const panel = loader.createComp(UI_COMPONENTS.gameMain) as fgui.GComponent;
        if (!panel) {
    ...
    refreshInfoCard(): void {
        ...
        let txtCoin = this.infoCard?.getChild('txtCoin') as fgui.GTextField;
        let txtRep = this.infoCard?.getChild('txtRep') as fgui.GTextField;
        let txtDay = this.infoCard?.getChild('txtDay') as fgui.GTextField;
    ...
    private refreshInfo(panel: fgui.GComponent): void {
        this.btnOpenShop = panel.getChild('btnOpenShop') as fgui.GButton;
        this.btnCatchDemon = panel.getChild('btnCatchDemon') as fgui.GButton;
        this.btnOpenShop.getChild("text").text = "开店营业";
        this.btnCatchDemon.getChild("text").text = "缉妖除魔";

        this.text1 = panel.getChild('text1') as fgui.GTextField;
        this.text2 = panel.getChild('text2') as fgui.GTextField;
